package com.imperial.demo.controller;
...
import com.imperial.demo.service.convertor.ConvertorService;
...
public class ConversionController {
    ...
    @RequestMapping(value = "/{measurement}/{toSystem}/{value}",method = RequestMethod.GET,produces = {APPLICATION_JSON_VALUE,})
    ...
    @RequestMapping(value = "/measurements",method = RequestMethod.GET,produces = {APPLICATION_JSON_VALUE,})
    public ResponseEntity<List<String>> getMeasurements() {
        return convertorService.getMeasurements();
    }

    @RequestMapping(value = "/si-units",method = RequestMethod.GET,produces = {APPLICATION_JSON_VALUE,})
